...
export const routes: Routes = [
...

  {
    ...
    children: [
      ...
      { path: 'shipping-delivery', loadComponent: () => import('./features/shipping-delivery/shipping-delivery.component').then(m => m.ShippingDeliveryComponent) },
      ...
      // Route chỉ dành cho OPERATOR
      {
        ...
        children: [

          {
            path: '',
            loadComponent: () =>
              import('./features/operator/operator-tasks/operator-tasks.component')
                .then(m => m.OperatorTasksComponent)
          },
          ...
          // DASHBOARD
          {
            path: 'verify',
            loadComponent: () =>
              import('./features/checkout/pet-logistics/dashboard/dashboard.component')
          ...
          // SCANNER
          {
            path: 'verify/scanner',
            loadComponent: () =>
              import('./features/checkout/pet-logistics/scanner/scanner.component')
          ...
          // DETAIL (nếu có)
          {
            ...
            loadComponent: () =>
              import('./features/checkout/pet-logistics/detail/detail.component')
          ...
          // REPORT
          {
            path: 'verify/report',
            loadComponent: () =>
              import('./features/checkout/pet-logistics/report/report.component')
